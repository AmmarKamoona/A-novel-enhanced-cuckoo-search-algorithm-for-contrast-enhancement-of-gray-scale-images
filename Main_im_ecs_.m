...
%publisher={Elsevier}
%}
% how to use by specifying the image Id and number of iteration
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
snd=stdfilt(gray_image);
   ...
   %%%%%%%%%%%%%%%%Enhanced cucckoo algorithm start from here%%%%%%%%%%%%%%
...
filename=[Currend_Folder,'\processed_images\','FSIM',final_string,'.mat'];
